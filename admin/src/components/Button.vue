...
<template>
  <button type="submit" :class="{ 'primary': color === 'primary', 'secondary': color === 'secondary', 'outline': color === 'outline', 'w-full text-center': size === 'full' }">
...
<style scoped>
.primary {
  @apply flex items-center justify-center gap-1.5 py-3.5 px-4 bg-primary font-semibold text-white text-base rounded-md transition-colors hover:bg-primary-hover focus:outline-none focus:ring-2 focus:ring-green-600 focus:bg-primary active:bg-primary-pressed
}
.secondary {
