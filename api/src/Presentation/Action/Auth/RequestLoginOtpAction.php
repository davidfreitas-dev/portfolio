...
use App\Application\DTO\Auth\LoginOtpRequestDTO;
...
class RequestLoginOtpAction
{
    ...
    public function __invoke(Request $request, Response $response): Response
    {
        ...
        $this->authService->requestLoginOtp($dto->email);

        return $this->responder->success($response, 'Se o e-mail existir, um código OTP foi enviado.');
    }
}
