...
<template>
  <Switch
    ...
    :class="isChecked ? 'bg-primary-default ' : 'bg-gray-200 dark:bg-gray-600'"
  ...
  >
    ...
    <span
      ...
      class="pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white dark:bg-gray-200 shadow-lg ring-0 transition duration-200 ease-in-out"
    />
  </Switch>
</template>
